  ...
  function widget( $args, $instance ) {
    ...
    ?>
        ...
        <form role="form" action="<?php echo $url; ?>" method="post" target="popupwindow" onsubmit="window.open('<?php echo $url; ?>', popupwindow, scrollbars=yes,width=800,height=600);return true">
          ...
          <?php
          if ( $instance['attribution'] ) echo '<p><small><a href="http://tinyletter.com" title="'.__('A TinyLetter email newsletter', 'tinyletter-widget').'">'.__('A TinyLetter email newsletter', 'tinyletter-widget').'</a></small></p>';
          ?>
      </form>
    </div>
